<?php
//define('C_REST_CLIENT_ID','local.5eb08eae351840.60208231');//Application ID
//define('C_REST_CLIENT_SECRET','gY5xlPya1XstvNuyKUS1YycYAEIylNTt1ExMiObzdHEI0CzLAY');//Application key
// or
